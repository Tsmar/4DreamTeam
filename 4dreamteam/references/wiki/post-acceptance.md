# Wiki Post-Acceptance

Use this mode after accepted quality timeline evidence when delivered behavior needs documentation.
...
8. Append `wiki_report` timeline evidence through `4dt-board`.

Do not document rejected or unverified behavior as fact.
