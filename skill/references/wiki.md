...
`wiki` supports project knowledge bases: it creates, checks, syncs, designs, and deepens documentation.
...
8. If mode rules conflict with `shared.md`, use the stricter rule.
