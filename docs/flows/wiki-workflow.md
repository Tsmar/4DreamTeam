...
owner: wiki
source_refs: ["sources/4DreamTeam/4dreamteam/references/wiki.md", "sources/4DreamTeam/4dreamteam/references/wiki/index.md", "sources/4DreamTeam/4dreamteam/references/wiki/shared/page-shape.md", "sources/4DreamTeam/4dreamteam/references/wiki/bootstrap.md", "sources/4DreamTeam/4dreamteam/tools/wiki/src/fourdt_wiki/cli.py"]
task_refs: []
---
...
- `sources/4DreamTeam/4dreamteam/tools/wiki/src/fourdt_wiki/cli.py` defines current wiki commands, validation, and export behavior.
...
- Use `4dt-wiki` for all managed wiki page writes.
- Use `4dt-sources` for source registry, inventory, search, and snippets.
